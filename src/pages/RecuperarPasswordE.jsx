...
const RecuperarPasswordE = () => {
  ...
  const changePassword = async (data) => {
    ...
    setLoading(true);
    try {
      const url = `${import.meta.env.VITE_BACKEND_URL}/nuevo-password-e/${token}`;
  ...
  useEffect(() => {
    const verifyToken = async () => {
      const url = `${import.meta.env.VITE_BACKEND_URL}/recuperar-password-e/${token}`;
      try {
...
export default RecuperarPasswordE;
